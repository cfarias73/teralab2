...
export const FieldEditor: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-900 relative">
      ...
      {/* Bottom Inputs */}
      <div className="absolute bottom-0 left-0 right-0 p-5 z-20 bg-gradient-to-t from-black/60 via-black/30 to-transparent pb-8">
         <div className="max-w-md mx-auto space-y-3">
             <div className="flex items-center space-x-2">
                 <div className="flex-grow bg-white/70 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-white/40">
                    <input 
                        type="text" 
                        placeholder="Nombre del campo"
                        className="w-full bg-transparent p-4 text-gray-900 placeholder-gray-600 font-medium outline-none"
                        value={parcelName}
                 ...
                 <div className="bg-primary-700/90 backdrop-blur p-4 rounded-2xl shadow-lg text-primary-100 border border-primary-500/50 flex items-center justify-center aspect-square">
                    <Sprout size={24} />
                 </div>
             </div>

             <div className="flex items-center space-x-2">
                 <div className="w-1/2 bg-white/70 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-white/40">
                     <div className="relative">
                        {showCustomCropInput ? (
                            <div className="relative w-full">
                                <input
                                    type="text"
                                    className="w-full bg-transparent p-4 text-gray-900 font-medium outline-none pr-10"
                                ...
                                <button 
                                    ...
                                    className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:text-red-500 p-1"
                                >
                                    <X size={16} />
                                </button>
                            </div>
                            ...
                            <>
                                <select 
                                    className="w-full bg-transparent p-4 text-gray-900 font-medium outline-none appearance-none"
                 ...
                 <div className="w-1/2 bg-white/70 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-white/40">
                     <div className="relative">
                        ...
                        <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-600">
                             {stage === 'preparation' ? <Tractor size={16}/> : <TrendingUp size={16}/>}
                        </div>
                     </div>
                 </div>
             </div>
             ...
             <div className="w-full">
                 {isPlanMode ? (
                     <button 
                        ...
                        disabled={isSaving}
                        className="w-full bg-emerald-500 hover:bg-emerald-400 backdrop-blur-md text-white font-bold p-4 rounded-2xl shadow-lg border border-white/20 flex items-center justify-center space-x-2 transition-transform active:scale-95 animate-in slide-in-from-bottom-2 disabled:opacity-70"
                     >
                     ...
                     <button 
                        ...
                        className="w-full bg-white/90 hover:bg-white backdrop-blur-md text-primary-800 font-bold p-4 rounded-2xl shadow-lg border border-white flex items-center justify-center space-x-2 transition-transform active:scale-95"
                     >
