    ...
    <div className={`flex flex-col h-full w-full relative bg-gray-100 overflow-hidden ${isPickingLocation ? 'cursor-crosshair' : ''}`}>
      ...
      <div className="absolute bottom-24 right-4 z-10">
        <button 
          ...
          className={`p-4 rounded-full shadow-glass-hover transition-all duration-300 transform active:scale-90 border-2 border-white/20 backdrop-blur-md flex items-center justify-center ${
            isPickingLocation 
        ...
        <div className="flex items-center space-x-2 pointer-events-auto pr-4">
            ...
            {availableCrops.map(crop => (
                <button
                    ...
                    className={`whitespace-nowrap px-3 py-1.5 rounded-full text-xs font-bold backdrop-blur-md shadow-sm transition-all border ${
                        filterCrop === crop 
      ...
      {!selectedParcel && (
        <div className="absolute bottom-24 left-4 z-10 glass-panel p-3 rounded-xl animate-in fade-in slide-in-from-left-5 backdrop-blur-md bg-white/80">
      ...
      {selectedParcel && (
        <div className="absolute bottom-20 left-4 right-4 z-20 animate-in slide-in-from-bottom-10 fade-in duration-300">
